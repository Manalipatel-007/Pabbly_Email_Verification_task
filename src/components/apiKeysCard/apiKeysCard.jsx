        ...
        <CardContent>
          ...
          <Box mt={2}>
            ...
            <Typography variant="caption" color="textSecondary" mt={1} display="block">
              ...
              share with others.{' '}
              <a href="#" style={{ textDecoration: 'underline', color: '#078DEE' , fontSize:'12px'}}>
                Learn more
              </a>
            </Typography>
          </Box>
          ...
          <Box mt={2}>
            ...
            <Typography variant="caption" color="textSecondary" mt={1} display="block">
              Use the &apos;Copy&apos; button to securely copy it. Keep it private and don&apos;t
              share with others.{' '}
              <a href="#" style={{ textDecoration: 'underline', color: '#078DEE' }}>
                Learn more
              </a>
            </Typography>
          </Box>
          ...
          <Box
            mt={3}
            sx={{
              width: { xs: '100%', sm: '200px' }, // full width on mobile, fixed width on tablet+
            }}
          >
            <Button
              variant="contained"
